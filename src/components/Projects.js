...
const Projects = () => {
  const featuredProjects = [
    ...
    },
    {
      ...
      description:
        'Dynamic e-commerce platform built using JSP, Servlets, and MySQL with Docker deployment. Includes secure payment gateway integration and interactive UI via JSTL.',
      image: '/ecommerce.png',
    ...
    },
    {
      ...
      description:
        'Full-stack chat app with Go backend (Gin), WebSocket integration, JWT authentication, and modern Next.js frontend. Enables real-time messaging and secure login.',
      image: '/chat-app.png',
